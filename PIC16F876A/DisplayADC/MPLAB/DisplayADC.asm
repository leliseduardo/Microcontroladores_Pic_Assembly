;
;		O objetivo deste programa é mostrar no display a leitura que esta sendo feita no ADC.
;
;		No debug e na prática o programa e o circuito funcionaram perfeitamente.
;
