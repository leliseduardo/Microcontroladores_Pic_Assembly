;
;		O objetivo deste programa é utilizar três display de 7 segmentos multiplexados para, finalmente, demonstrar a 
;	tensão lida pelo voltímetor desenvolvidos nas últimas aulas. Para isso, será uitilizado o timer0 para multiplexação
;	dos displays e uma subrotina que decodifica o display.
;		Grande parte deste código foi apenas copiado do código disponibilizado pelo professor, porém, muita coisa que 
;	foi feita eu já fiz em outros projetos em Assembly e em C, logo, mesmo que eu não tenha escrito a minha própria 
;	maneira, o código todo foi entendido. Além disso, como juntei os códigos da última aula e ainda escrevi uma coisa ou
; 	outra, o código foi totalmente entendido.
;		
