;
;		O objetivo deste programa é escrever uma mensagem no display LCD. Este código foi copiado do código demonstrado
;	na aula, mas foi completamente compreendido.
;
;		Na simulação e na prátiva o circuito e o programa funcionaram perfeitamente.
;
...
inicio:
	...
	call		lcd_hello					; Chama a subrotina para escrever no LCD
...
lcd_hello:
    ...
    call    	lcd_char					;envia caractere para o LCD
	movlw   	'k'							;move caractere para work
    call    	lcd_char					;envia caractere para o LCD
	movlw  	 	'u'							;move caractere para work
    call    	lcd_char					;envia caractere para o LCD
	movlw   	'n'							;move caractere para work
    call    	lcd_char					;envia caractere para o LCD
	movlw   	'a'							;move caractere para work
    call    	lcd_char					;envia caractere para o LCD
	movlw   	' '							;move caractere para work
