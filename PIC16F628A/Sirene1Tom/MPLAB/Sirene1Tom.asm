;
;		O objetivo deste programa é utilizar este código, feito na aula passada, denominada "CorrecaoLatencia", e aplicar
;	num circuito com um buzzer, produzindo uma sirene de 1 tom.
;
;
;	*** Timer 1 ***
;	
