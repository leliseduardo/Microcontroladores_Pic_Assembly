...
;
;		Este programa tem a função de piscar um led a cada mais ou menos 500ms, utilizando a interrupção
;	do timer 0 para isso.
;
;		Timer 0
;
...
;		Overflow = 31ms
;		
;		No debug, na simulação e na prática o programa funcionou como esperado. O tempo de overflow mais a base de tempo
;	criada com "cont" geraram o tempo esperado, de +-566ms.	
;
...
; --- Final do salvamento de contexto ---
	...
	movlw		D'18'						; w = 18d
	movwf		cont						; recarrega cont com 18d
