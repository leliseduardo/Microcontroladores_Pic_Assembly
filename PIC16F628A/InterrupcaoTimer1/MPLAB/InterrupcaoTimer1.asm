;
;		O objetivo deste programa é demonstrar como fazer a configuração da interrupção do timer1. A simples função será
;	mudar o estado do pino RB7 a cada interrupção, mas é um bom jeito de iniciar na interrupção deste timer.
;
;	*** Timer 1 ***
;	
...
;	Overflow = 65,536ms
;
;		Na simulação e na prática o programa funcionou perfeitamente.
;
...
; -- Fim do salvamento de contexto --
	...
	comf		PORTB						; Complementa todas as saídas do PORTB, no caso, somente RB7
