;
;		Este programa tem o objetivo de demosntrar a configuração de dois osciladores configurados a partir do timer1.
;	Cada oscilador terá uma saída independente (RB7 e RB6), e cada uma terá uma base de tempo diferente, mas ambas utili-
;	zarão o timer1 para a temporização.
;		O primeiro oscilador terá o tempo de overflow do timer1, de 500us. O segundo terá um tempo de 4ms, que 8 vezes o
;	tempo de overflow.
;
;
;	*** Timer 1 ***
...
;	TMR1L = 0Ch
;
;		Na simulação o circuito funcionou como esperado, com os tempos exatos de acordo como configurado.
;
